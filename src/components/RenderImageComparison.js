...
export default function RenderImageComparison(props) {
  return (
    <div id="container-RenderImageComparison" className="container grid grid-x large-6 medium-6 small-12">
      <div id="container-image" className="large-12 medium-12 small-12">
